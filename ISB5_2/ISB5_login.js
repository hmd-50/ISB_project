...
function  Language() {
    ...
    if (isArabic == true) {
       ...
       /* b2.textContent = " show ";
        ...
        p1.textContent = " don't have an account? ";
        p2.textContent = " sign up now ";
       ...
       /* b2.textContent = " عرض  ";
        b3.textContent = " حفظ ";
        b4.textContent = " مسح ";*/
        b5.textContent = " تسجيل الدخول ";
        
        p1.textContent = " ليس لديك حساب؟ ";
        p2.textContent = " سجل الان ";
...
if (found) {
   ...
   window.location.replace("ISB5_main.html",);
